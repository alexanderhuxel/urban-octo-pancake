    ...
    <div class="flex flex-col items-center w-">
        ...
        <div class="flex border-b mt-2 border-white-200 border-opacity-50 border-opa flex-row">
            <span class="flex items-center flex-row">
                <p class="font-quicksand mr-2.5 ml-0 font-bold text-white-100">
                    {{ $teamName1 }}
                </p>
                <img class="w-12 h-12 mr-2 hidden md:block rounded-full" src="{!! $imageUrl1['0'] !!}">
            </span>
            <span class="mx-2">
                <p class="font-quicksand text-body text-white-100 opacity-75">
                    {{ $date }}
                </p>
                <span class="flex  flex-row ">
                    <p class="font-roadrage  text-white-100 text-h2">
                        {{ $teamPoints1 }}
                    </p>
                    <p class="font-roadrage text-white-100 mx-1.5 text-h2">
                        :
            ...
            <span class="flex items-center flex-row">
                <img class="w-12 h-12 ml-2 hidden md:block rounded-full" src="{!! $imageUrl2['0'] !!}">
                <p class="font-quicksand ml-2.5 mr-0 font-bold text-white-100">
                    {{ $teamName2 }}
                </p>
            </span>
        </div>
